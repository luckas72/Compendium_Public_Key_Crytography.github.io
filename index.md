...
<p>
<h2><img width=2% height=2% alt="Key" title="Key icon" src="/icons/key.png">Public Key Cryptography</h2>
...
<p>
<h2><img width=2% height=2% alt="Important icon" title="Important icon" src="/icons/important.png">Importance</h2>
...
<h3><img width=2% height=2% alt="Key" title="Key icon" src="/icons/ct.png">Public key certificate</h3>
...
A good alternative is to use public-key certificates. When Bob wants to communicate with Alice, he can follow the steps below :
 <p align="center">
 <img width=2% height=2% alt="User 1 icon" title="User 1 icon" src="/icons/user1.png"><img width=2% height=2% alt="Communication Icon" title="Communication icon" src="/icons/comm.png"><img width=2% height=2% alt="User 2 icon" title="User 2 icon" src="/icons/user2.png">
 </p>
<ol>
...
<h3><img width=2% height=2% alt="Algorithm icon" title="Algorithm icon" src="/icons/algo.png">RSA cryptosystem</h3>
<p>
...
<h2><img width=2% height=2% alt="Solution icon" title="Solution icon" src="/icons/sol.png">Public key management solution</h2>
<p>
...
<h2><img width=2% height=2% alt="Future icon" title="Future of cryptography" src="/icons/future.png">Future of Cryptography</h2>
<p>
